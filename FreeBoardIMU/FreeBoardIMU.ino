...
void SK_output(float h){
    //heading
    Serial.print("{\"context\": \"vessels.self\",\"updates\": [{\"values\": [");
    Serial.print("{\"path\": \"navigation.headingMagnetic\",\"value\":");
    Serial.print(h*PI/180.0,8);
    Serial.print("},");
    //rot
    Serial.print("{\"path\": \"navigation.rateOfTurn\",\"value\":");
    Serial.print(rotList.getTotalAverage()*PI/(180.0*60.0),8);//rad/s
    Serial.print("},");
    //attitude
    Serial.print("{\"path\": \"navigation.attitude\",\"value\": {");
    Serial.print("\"roll\":");
    Serial.print(degrees(yprm[2])*PI/180.0,8);//rad
    Serial.print(",\"pitch\":");
    Serial.print(degrees(yprm[1])*PI/180.0,8);//rad
    Serial.print(",\"yaw\":");
    Serial.print(degrees(yprm[0])*PI/180.0,8);//rad
    Serial.print("}}");
    //temp
